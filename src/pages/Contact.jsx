...
function Contact() {
  return (
    <div className="container max-w-screen-kxl my-0 pt-0 p-2 md:p-10 md:pt-0 h-[590px] max-h-screen-kxl md:h-screen  text-black  bg-slate-900">
      <NavBar />
      <div className="relative p-10 rounded-xl my-10 bg-white opacity-80 shadow-lg min-w-screen">
