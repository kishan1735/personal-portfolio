...
function Skills() {
  return (
    <div className="container w-screen max-w-screen-2xl my-0 pt-0 p-2 md:p-10 md:pt-0 h-full min-h-screen 2xl:h-screen  text-black  bg-slate-900 text-center md:text-start">
      <NavBar />
